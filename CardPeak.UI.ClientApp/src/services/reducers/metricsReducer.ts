...
export default handleActions<CardPeak.Models.MetricsModel, any>(
    {
        ...
        [METRIC_ACTIONS.GET_AGENT_METRICS_COMPLETE]: (
            state,
            action
        ) => {
            return {
        ...
        [METRIC_ACTIONS.GET_AGENT_RANKING_METRICS_COMPLETE]: (
            state,
            action
        ) => {
            return {
        ...
        [METRIC_ACTIONS.GET_AGENT_PERFORMANCE_METRICS_COMPLETE]: (
            state,
            action
        ) => {
            return {
        ...
        [METRIC_ACTIONS.GET_AGENT_THRESHOLD_METRICS_COMPLETE]: (
            state,
            action
        ) => {
            return {
        ...
        [METRIC_ACTIONS.GET_AGENT_DISBURSEMENT_METRICS_COMPLETE]: (
            state,
            action
        ) => {
            return {
        ...
        [METRIC_ACTIONS.GET_BANK_AMOUNT_DISTRIBUTION_METRICS_COMPLETE]: (
            state,
            action
        ) => {
            return {
