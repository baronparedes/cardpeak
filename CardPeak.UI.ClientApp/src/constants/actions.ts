export const AGENT_ACTIONS = {
    ...
    REFRESH_AGENT_DASHBOARD_COMPLETE:
        'REFRESH_AGENT_DASHBOARD_COMPLETE',
...
export const METRIC_ACTIONS = {
    ...
    GET_AGENT_RANKING_METRICS_COMPLETE:
        'GET_AGENT_RANKING_METRICS_COMPLETE',
    GET_AGENT_PERFORMANCE_METRICS_COMPLETE:
        'GET_AGENT_PERFORMANCE_METRICS_COMPLETE',
    GET_AGENT_THRESHOLD_METRICS_COMPLETE:
        'GET_AGENT_THRESHOLD_METRICS_COMPLETE',
    GET_AGENT_DISBURSEMENT_METRICS_COMPLETE:
        'GET_AGENT_DISBURSEMENT_METRICS_COMPLETE',
    GET_BANK_AMOUNT_DISTRIBUTION_METRICS_COMPLETE:
        'GET_BANK_AMOUNT_DISTRIBUTION_METRICS_COMPLETE'
};
