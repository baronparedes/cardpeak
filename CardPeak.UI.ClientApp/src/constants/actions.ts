...
export const METRIC_ACTIONS = {
    ...
    GET_AGENT_TRESHOLD_METRICS_COMPLETE: "GET_AGENT_TRESHOLD_METRICS_COMPLETE",
    GET_BANK_AMOUNT_BREAKDOWN_METRICS_COMPLETE: "GET_BANK_AMOUNT_BREAKDOWN_METRICS_COMPLETE"
}
