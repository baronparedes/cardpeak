...
export default class AgentSavingsActions extends React.Component<
    AgentSavingsActionsProps,
    AgentSavingsActionsState
> {
            ...
            <Col md={12} xsHidden className="text-right hidden-print">
                <ButtonGroup
                    ...
                    <Button
                        ...
                        <ButtonLoadingText
                            isLoading={
                                this.props.refreshingAgentSavings
                            }
                            label="refresh"
                        />
                    </Button>
    ...
    renderSmallButtons() {
        return (
            <Col
                ...
                <ButtonGroup
                    className="spacer-top spacer-bottom spacer-right-sm"
                    disabled={this.props.refreshingAgentSavings}>
                    <Button
                        onClick={this.handleOnRefreshTransactions}
                        bsStyle="primary"
        ...
        return (
            <DebitCreditTransactionFormModal
                ...
                onTransactionSubmitted={
                    this.handleOnRefreshTransactions
                }
