...
class SelectAgentContainer extends React.Component<
    SelectAgentContainerProps &
        SelectAgentContainerPropsConnect &
        SelectAgentContainerDispatchProps,
    { showModal: boolean }
> {
    constructor(
        props: SelectAgentContainerProps &
            SelectAgentContainerPropsConnect &
            SelectAgentContainerDispatchProps
    ) {
        super(props);
