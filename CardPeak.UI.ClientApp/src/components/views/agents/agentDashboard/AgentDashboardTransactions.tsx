...
export default class AgentDashboardTransactions extends React.Component<
    AgentDashboardTransactionsProps,
    AgentDashboardTransactionsState
> {
        ...
        return (
            <div>
                ...
                <ApprovalTransactionList
                    data={
                        this.props.agentDashboard.approvalTransactions
                    }
                    hideSearchBar
                />
            </div>
            ...
            <div>
                <div className="text-right spacer-bottom hidden-print">
                    ...
                    <Toggle
                        ...
                        onToggle={(on: boolean) =>
                            this.setState({ transactionView: on })
                        }
                    />
                </div>
