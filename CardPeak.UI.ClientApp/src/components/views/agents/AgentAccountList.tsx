...
class AgentAccountDetailRowLayout extends React.Component<
    AgentAccountDetailRowLayoutProps,
    undefined
> {
...
class AgentAccountList extends React.Component<
    AgentAccountListProps,
    AgentAccountListState
> {
    ...
    render() {
        return (
            <div>
                ...
                <GridList
                    header={
                        <AgentAccountDetailRowLayout isHeader={true} />
                    }>
                    {this.props.agent.accounts &&
                    this.props.agent.accounts.length > 0 ? (
