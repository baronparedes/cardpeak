...
import { FormFieldDropdown } from '../../layout';
...
class ReferencePickerContainer extends React.Component<
    CardPeak.Models.SettingsModel & Props & DispatchProps,
    State
> {
    constructor(
        props: CardPeak.Models.SettingsModel & Props & DispatchProps
    ) {
        super(props);
        this.state = {
            data: []
    ...
    componentWillReceiveProps(
        nextProps: CardPeak.Models.SettingsModel & Props
    ) {
    ...
    getData = (
        props: CardPeak.Models.SettingsModel & Props
