...
class DebitCreditTransactionFormContainer extends React.Component<
    DebitCreditTransactionFormProps &
        DebitCreditTransactionFormPropsConnect &
        DebitCreditTransactionFormDispatchProps,
    DebitCreditTransactionFormState
> {
    constructor(
        props: DebitCreditTransactionFormProps &
            DebitCreditTransactionFormPropsConnect &
            DebitCreditTransactionFormDispatchProps
    ) {
        super(props);
    ...
    handleOnConfirm = () => {
        ...
        this.props.actions.postAgentTransactionStart(
            ...
            this.handleOnTransactionSubmitted,
            this.handleOnTransactionSubmittedError
        );
    };
                    ...
                    <fieldset disabled={this.props.postingTransaction}>
                        ...
                        {this.props.showTransactionDate && (
                            <FormFieldDate
                                ...
                                onChangeDate={
                                    this.handleOnTransactionDateChange
                                }
                            />
                        )}
                        <FormGroup>
