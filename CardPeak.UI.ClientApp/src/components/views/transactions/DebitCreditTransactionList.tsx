...
const DebitCreditTransactionList = (
    ...
    return (
        <div>
            <DebitCreditTransactionDataList
                ...
                renderHeader={() => {
                    return (
                        <DebitCreditTransactionListRowLayout isHeader />
                    );
                }}
                renderItem={(item, key) => {
                    return (
                        <DebitCreditTransactionListRowLayout
                            item={item}
                            key={key}
                        />
                    );
