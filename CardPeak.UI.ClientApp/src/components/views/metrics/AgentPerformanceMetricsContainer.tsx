...
type AgentPerformanceMetricsDataList = new () => DataListFiltered<
    CardPeak.Entities.AgentPerformanceMetric
>;
...
const AgentPerformanceMetricsRowLayout: React.StatelessComponent<DataItemProps<
    CardPeak.Entities.AgentPerformanceMetric
> &
    AgentPerformanceMetricsRowLayout> = props => {
    return (
        <Row>
            <Col
                mdHidden
            ...
            {props.isHeader ? null : (
                <Col sm={8} xs={12}>
                    <PerformanceDashboard
                        performance={props.item.performance}
                        hideAmount
                    />
                </Col>
            )}
            {!props.isHeader && props.showCharts ? (
                <Col sm={12} xsHidden>
                    <MetricsLineChart
                        metrics={props.item.performance}
                    />
                </Col>
            ) : null}
        </Row>
...
class AgentPerformanceMetricsContainer extends React.Component<
    CardPeak.Models.MetricsModel &
        AgentPerformanceMetricsContainerDispatchProps,
    { showCharts?: boolean }
> {
    constructor(
    ...
    componentDidMount() {
        ...
        this.props.actions.getAgentPerformanceMetricsStart(
            ...
            <div>
                ...
                <div>
                    <YearMonthAction
                        ...
                        onRefresh={
                            this.props.actions
                                .getAgentPerformanceMetricsStart
                        }
                    />
                    <br />
                    <Grid>
                        ...
                        <Row>
                            <AgentPerformanceMetricsDataList
                                ...
                                data={
                                    this.props.agentPerformanceMetrics
                                }
                            />
                        </Row>
                    </Grid>
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AgentPerformanceMetricsContainer);
