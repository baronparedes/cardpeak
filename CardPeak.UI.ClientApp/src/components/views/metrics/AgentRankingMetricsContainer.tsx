...
type AgentRankingMetricsDataList = new () => DataListFiltered<
...
const AgentRankingMetricsRowLayout: React.StatelessComponent<DataItemProps<
    CardPeak.Entities.AgentRankMetric
>> = props => {
    return (
        <Row>
...
class AgentRankingMetricsContainer extends React.Component<
    CardPeak.Models.MetricsModel &
        AgentRankingMetricsContainerProps &
        AgentRankingMetricsContainerDispatchProps,
    AgentRankingMetricsContainerState
> {
    constructor(
    ...
    componentDidMount() {
        ...
        this.props.actions.getAgentRankingMetricsStart(
