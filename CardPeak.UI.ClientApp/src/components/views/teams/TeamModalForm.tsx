...
import { ErrorLabel, FormFieldInput, ModalPanel } from '../../layout';
...
class TeamModalForm extends React.Component<
    TeamModalFormProps,
    TeamModalFormState
> {
    ...
    componentWillReceiveProps(nextProps: TeamModalFormProps) {
        if (
            this.state.team.teamId != nextProps.team.teamId ||
            nextProps.team.teamId === 0
        ) {
            this.setState({
                team: nextProps.team
            });
