...
const SelectTeamListRowLayout = (
    props: DataItemProps<CardPeak.Entities.Team> & SelectTeamListProps
) => {
    return (
        <Row className="team-item">
            ...
            <Col sm={2}>
                {props.isHeader ? (
                    ...
                    <Button
                        onClick={() => {
                            props.onTeamSelected(props.item);
                        }}
                        bsStyle="primary"
                        bsSize="sm">
                        Select
...
const SelectTeamList = (
    props: DataListProps<CardPeak.Entities.Team> & SelectTeamListProps
) => {
    return (
        <div>
            <TeamDataListFiltered
                ...
                renderHeader={() => {
                    return <SelectTeamListRowLayout isHeader />;
                }}
                renderItem={(item, key) => {
                    return (
                        <SelectTeamListRowLayout
                            item={item}
                            key={key}
