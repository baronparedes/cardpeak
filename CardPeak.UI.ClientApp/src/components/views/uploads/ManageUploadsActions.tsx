...
export default class ManageUploadsActions extends React.Component<ManageUploadsActionsProps, ManageUploadsActionsState> {
                    ...
                    <Row>
                        ...
                        <Col lg={5} md={5} sm={5}>
                            <DatePicker
                                ...
                                disabled={this.props.refreshing || this.props.disabled} />
                        </Col>
                        <Col lg={1} md={1} sm={1}>
    ...
    renderButtons() {
        return (
            <Col lg={6} md={6} sm={12} xs={12} className="text-right">
                <ButtonGroup disabled={this.props.refreshing || this.props.disabled}>
                    <Button
