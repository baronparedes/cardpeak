...
import { ConfirmButton, ErrorLabel, FormFieldFile } from '../../layout';
...
class BatchUploadContainer extends React.Component<
    CardPeak.Models.BatchUploadModel &
        BatchUploadContainerDispatchProps,
    BatchUploadContainerState
> {
    constructor(
        props: CardPeak.Models.BatchUploadModel &
            BatchUploadContainerDispatchProps
    ) {
        super(props);
        this.state = {
    ...
    handleOnUpload = () => {
        ...
        this.props.actions.uploadFileStart(
            formData,
            () => {
                this.setState({
                    fileName: '',
    ...
    render() {
        return (
            <div>
                ...
                />
                {!this.props.processingCompleted ||
                !this.props.selectedBatchUpload.hasErrors ? null : (
                    <BatchUploadErrorList
                        data={this.props.processedApprovalTransactions}
                    />
                )}
            </div>
        );
