...
import { DatePicker, ButtonLoadingText } from './'
...
export class DateRangeAction extends React.Component<DateRangeActionsProps, DateRangeActionsState> {
	...
	renderDateFilters() {
		return (
			<div className="no-padding">
				<Row>
					<Col md={6} sm={6}>
						<label className="text-muted">{this.props.startDateLabel}</label>
						<DatePicker
					...
					<Col md={6} sm={6}>
						{
							this.props.hideEndDate ? null :
								<div>
									<label className="text-muted">{this.props.endDateLabel}</label>
									<DatePicker
