...
export class NavigationBar extends React.Component<{}, undefined> {
	getMetricsNavs(): RenderNavDropdownProps {
		...
		const navs: NavProps[] = [
			{ text: "Agents", fa: "fa-user", exact: true, to: "/metrics/agents" },
			...
			{ text: "Agent Disbursement", fa: "fa-exchange", exact: true, to: "/metrics/agents/disbursement" },
			{ divider: true },
			{ text: "Bank Amount Distribution", fa: "fa-pie-chart", exact: true, to: "/metrics/banks/amountdistribution" }
		];
	...
	getAgentsNavs(): RenderNavDropdownProps {
		...
		const root: NavProps = { to: "/agents", text: "Agents", fa: "fa-user", addOn: <PayoutBadgeContainer /> };
		const navs: NavProps[] = [
	...
	getTeamsNavs(): RenderNavDropdownProps {
		...
		const root: NavProps = { to: "/teams", text: "Teams", fa: "fa-users" };
		const navs: NavProps[] = [
