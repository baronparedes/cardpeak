...
public partial class Agent
{
    ...
    public Agent()
    {
        ...
        this.TeamPlacements = new HashSet<TeamPlacement>();
    ...
    public virtual ICollection<TeamPlacement> TeamPlacements { get; set; }

    public virtual Reference AgentType { get; set; }
